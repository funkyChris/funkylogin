...
public class ClockServiceBean implements ClockService {
	...
	public String getTime() throws ClockServiceException {
        try {
            return DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.SHORT).format(new Date()) + " asked by " +  membership.getProfilePathForConnectedIdentifier();
        } catch (MembershipServiceException e) {
            return DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.SHORT).format(new Date()) + " with error of membership " + e; 
        }
	}
